...
import com.Geetham.exception.PhotoReterivalException;
...
public class RoomController {
    ...
    public ResponseEntity<RoomResponse> udpateRoom(@PathVariable Long roomId,
    ...
    private RoomResponse getRoomResponse(Room room) {
        ...
        if(photoBlob != null){
            try{
                ...
                throw new PhotoReterivalException("Error retriving photo");
            }
        }
